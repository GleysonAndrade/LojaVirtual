...
if(isset($_POST['cli_nome']) and isset($_POST['cli_email']) and isset($_POST['cli_cpf'])){
    ...
    if(!$cliente->EditarADM($_SESSION['cli']['cli_id'])){
        ...
        Rotas::Redirecionar(1, Rotas::pag_ClienteADM());
    }
	...
	$id = Rotas::$pag[1];
	$cliente->GetClienteId($id);
	foreach($cliente->GetItens()[1] as $campo => $valor){

		$smarty->assign(strtoupper($campo), $valor);
	}
	$smarty->display('adm_cliente_editar.tpl');
}
?>