    ...
    <body>
        ...
        <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="nav navbar-nav">
                                <li><a href="{$GET_SITE_ADM}"><i class="glyphicon glyphicon-home"></i> Home </a> </li>
                                 ...
                                 <li><a href="{$PAG_CATEGORIA}"><i class="glyphicon glyphicon-tag"></i> Categorias </a> </li>
                               
                                <li><a href="{$PAG_ADM_PRODUTO}"><i class="glyphicon glyphicon-user"></i> Produtos </a> </li>
                                <li><a href="{$PAG_ADM_CLIENTE}"><i class="glyphicon glyphicon-tag"></i> Clientes</a> </li>
                                <li><a href="{$PAG_ADM_PEDIDO}" ><i class="glyphicon glyphicon-envelope"></i> Pedidos </a> </li>
            ...
            <div class="container"> 
                ...
                <div class="list-group">
                    <span class="list-group-item active"> Categorias</span>
                     ...
                     <a href="{$PAG_ADM_PRODUTO}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> Todos</a> 

                    {foreach from=$CATEGORIA item=C}
                    
                    <a href="{$C.cat_link_adm}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> {$C.cat_nome}</a>  
            ...
            <div class="row" id="rodape">
                <center>
                    <h4>{$TITULO_SITE}</h4>
                    <P>Todos os Direitos Reservados - Gleyson Andrade - SystecWeb - Data Atual: {$DATA}</P>
                </center>
