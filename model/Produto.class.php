...
Class Produto extends Conexao{
    ...
    function GetProduto(){
        ...
        $query = "SELECT * FROM {$this->prefix}produto p INNER JOIN {$this->prefix}categoria c ON p.pro_categoria = c.cat_id" ;
    ...
    function GetProdutoId($id){
        ...
        $parms = array(':id'=>(int)$id);

        $this->ExecuteSQL($query, $parms);

        $this->GetLista();
    }

    function GetProdutoCatId($id){
        //query para buscar os produtos de uma categoria especifica.
        ...
        $query .= $this->PaginacaoLinks("pro_id", $this->prefix."produto WHERE pro_categoria=".(int)$id);
    ...
    function Inserir(){
        ...
        $query = " INSERT INTO {$this->prefix}produto (pro_nome, pro_categoria, pro_ativo, pro_modelo, pro_ref," ;
        ...
        function Alterar($id){
            ...
            $query = " UPDATE {$this->prefix}produto SET pro_nome =:pro_nome, pro_categoria =:pro_categoria";
            ...
            $query.= " pro_altura =:pro_altura, pro_largura =:pro_largura, pro_comprimento =:pro_comprimemto, pro_img =:pro_img, pro_desc =:pro_desc, pro_slug =:pro_slug";
            ...
            function Apagar($id){
                $query = "DELETE FROM {$this->prefix}produto";
