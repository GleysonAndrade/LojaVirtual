...
$(document).ready(function(){    
 ...
 <h3 class="text text-info text-center">Meu Carrinho</h3>
<hr>
<!-- botoes e opções de cima -->
<section class="row">
    
    <div class="col-md-4 ">
       <a href="{$PAG_PRODUTO}" class="btn btn-info" title="">Comprar Mais</a>
    </div>
    <div class="col-md-4">
...
<section class="row ">
    ...
    <section class="row" id="dadosfrete">
        <div class="col-md-4"></div>  
           ...
           <div class="col-md-4">
               <!-- botão frete -->
               <button class="btn btn-info btn-block" id="buscar_frete"> <i class="glyphicon glyphicon-send"></i> Calcular Frete </button>              
           </div>                      
    </section>
            <hr>
           <!-- botão finalzar -->
