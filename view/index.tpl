        ...
        <div class="container-fluid">
            ...
            <div class="row" id="topo">
                ...
                <div class="col-md-12 text-right">
                    {if $LOGADO == true}Olá: {$USER} <a href="{$PAG_LOGOFF}" class="btn btn-outline-primary"><i class="glyphicon glyphicon-log-out"></i> Sair </a> {/if}
                </div>  
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{$PAG_PRODUTO}"><i class="glyphicon glyphicon-tag"></i> Produtos </a> </li>
            ...
            <div class="container"> 
                ...
                <a href="{$PAG_PRODUTO}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> Todos</a> 
            ...
            <div class="row" id="rodape">
                <center><h4>{$TITULO_SITE}</h4>
                    <p>Todos os Direitos Reservados - Gleyson Alves - Analista e Desenvolvedor de Sistema - Data Atual: {$DATA}</p>
                </center>
            </div><!-- fim div rodape-->
